package com.weibo.widget.varunest.sparkbutton;
...
import com.weibo.widget.varunest.sparkbutton.heplers.CircleView;
import com.weibo.widget.varunest.sparkbutton.heplers.DotsView;
import com.weibo.widget.varunest.sparkbutton.heplers.Utils;

import static com.fanwe.g419.R.drawable.xr_ic_favorite_unchecked;
...
public class SparkButton extends FrameLayout implements View.OnClickListener {
    ...
    public void setChecked(boolean flag) {
        isChecked = flag;
        imageView.setImageResource(isChecked ? R.drawable.xr_ic_favorite_checked : R.drawable.xr_ic_favorite_unchecked);
