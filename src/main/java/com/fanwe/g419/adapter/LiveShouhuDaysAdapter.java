 ...
 */
public class LiveShouhuDaysAdapter extends SDSimpleAdapter<PayShouhuModel.GuardRuleListBean.RulesBean>
{

    private OnDaysViewClickListener mListener;

    public LiveShouhuDaysAdapter(List<PayShouhuModel.GuardRuleListBean.RulesBean> listModel, Activity activity)
    {
    ...
    @Override
    public void bindData(int position, View convertView, ViewGroup parent, PayShouhuModel.GuardRuleListBean.RulesBean model)
    {
            bindDaysData(convertView, model);
    }

    private void bindDaysData(View convertView, final PayShouhuModel.GuardRuleListBean.RulesBean model)
    {
    ...
    public interface OnDaysViewClickListener
    {
        ...
        void onClickDaysView(PayShouhuModel.GuardRuleListBean.RulesBean model);
    }
}
