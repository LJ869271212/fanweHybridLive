...
import com.fanwe.g419.activity.LiveRankingActivity;
...
public class LiveRankingContributionFragment extends LiveRankingBaseFragment
{
    ...
    private void initTabs()
    {
        ...
        tab_rank_week.getViewConfig(tab_rank_week.mIvUnderline).setBackgroundColorNormal(Color.TRANSPARENT).setBackgroundColorSelected(SDResourcesUtil.getColor(R.color.main_color));
