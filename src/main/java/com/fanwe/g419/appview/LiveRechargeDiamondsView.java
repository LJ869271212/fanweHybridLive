...
import com.fanwe.g419.adapter.LiveRechargePayDialogAdapter;
import com.fanwe.g419.adapter.LiveRechargeRuleAdapter;
 ...
 * 直播间充值窗口{@link com.fanwe.g419.dialog.LiveRechargeDialog} 充值视图
 */
...
//        ll_payment = find(R.id.ll_payment);//商品列表模块
    ...
    {
        SDViewBinder.setTextView(tv_account, "G币余额：" + mActModel.getDiamonds());
