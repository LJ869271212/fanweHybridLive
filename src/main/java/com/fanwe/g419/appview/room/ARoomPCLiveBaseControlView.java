...
public abstract class ARoomPCLiveBaseControlView extends ARoomPCBaseControlView {
    ...
    public ARoomPCLiveBaseControlView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        init();
    }

    public ARoomPCLiveBaseControlView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public ARoomPCLiveBaseControlView(Context context) {
        super(context);
        init();
    }
