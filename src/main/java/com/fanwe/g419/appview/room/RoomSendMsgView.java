...
import com.fanwe.g419.model.App_pop_msgActModel;
...
import com.fanwe.g419.view.MultyTabView;
...
public class RoomSendMsgView extends RoomView implements MultyTabView.TabChangeListener {
    ...
    public void tabChange(int index) {
        switch (index) {
            case 1:
                et_content.setHint("开启弹幕，" + popMsgDiamonds + "G币/条");
                break;
            case 0:
                et_content.setHint(SDResourcesUtil.getString(R.string.live_send_msg_hint_normal));
                break;
            case 2:
                et_content.setHint("开启大喇叭，" + fullMsgDiamonds + "G币/条");
                break;
