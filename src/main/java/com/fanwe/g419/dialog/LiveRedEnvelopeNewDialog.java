...
import com.fanwe.g419.adapter.LiveRedEnvelopeAdapter;
import com.fanwe.g419.appview.LiveRedEnvelopeOpenView;
import com.fanwe.g419.appview.LiveRedEnvelopeView;
...
import com.fanwe.g419.model.App_user_red_envelopeModel;
            ...
            protected void onSuccess(SDResponse resp)
            {
                ...
                if (actModel.getStatus() == 1)
                {
                    if (actModel.getDiamonds() > 0)
                    {
                        ...
                        red_info = "恭喜您抢到" + actModel.getDiamonds() + "个G币";
                    } else
                    {
                        red_info = "手太慢，已发完";
                    }
