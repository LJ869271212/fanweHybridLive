...
import com.fanwe.g419.activity.LiveMobielRegisterActivity;
    ...
    private void requestInit() {
        CommonInterface.requestInit(new AppRequestCallback<InitActModel>() {
            ...
            protected void onSuccess(SDResponse resp) {
                Log.i(InitBusiness.class.getSimpleName(), "onSuccess" + resp.getResult());
                if (actModel.isOk())
                {
            ...
            protected void onError(SDResponse resp) {
                Log.i(InitBusiness.class.getSimpleName(), "onError" + resp.getResult());
                super.onError(resp);
                onRequestInitError();
            }
        });
