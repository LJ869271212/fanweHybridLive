...
import com.fanwe.g419.appview.room.ARoomPCBaseControlView;
import com.fanwe.g419.appview.room.RoomContributionView;
import com.fanwe.g419.appview.room.RoomPCLiveView;
import com.fanwe.g419.appview.room.RoomPCMessageView;
import com.fanwe.g419.appview.room.RoomSendGiftView;
import com.fanwe.g419.appview.room.RoomView;
...
//    }
    ...
    {
        getViewerBusiness().requestRoomInfo(strPrivateKey);
    }
...
//            isInDelayJoinRoom = false;
    ...
    {
        if (!SDNetworkReceiver.isNetworkConnected(LivePCViewerActivity.this))
        {
