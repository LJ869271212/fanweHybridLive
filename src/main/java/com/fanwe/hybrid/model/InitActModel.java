...
import com.fanwe.g419.model.IpInfoModel;
...
public class InitActModel extends BaseActModel
{
    ...
    private int bullet_screen_diamond = 10;// 弹幕一次消费的G币
    ...
    private int open_home_invite;//是否显示首页悬浮窗按钮
    private String home_invite_img;//首页悬浮窗按钮图片
    ...
    private String rocket_content;

    public String getRocket_content() {
        return rocket_content;
    }

    public void setRocket_content(String rocket_content) {
        this.rocket_content = rocket_content;
    }

    public int getOpen_home_invite() {
        return open_home_invite;
    }

    public void setOpen_home_invite(int open_home_invite) {
        this.open_home_invite = open_home_invite;
    }

    public String getHome_invite_img() {
        return home_invite_img;
    }

    public void setHome_invite_img(String home_invite_img) {
        this.home_invite_img = home_invite_img;
    }
    ...
    private int open_send_diamonds_module;//是否开启赠送G币功能
    private int open_diamond_game_module;//是否使用G币作为游戏币，1表示是
