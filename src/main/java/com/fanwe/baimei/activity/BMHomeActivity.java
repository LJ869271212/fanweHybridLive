...
import com.fanwe.baimei.fragment.PayBaseFragment;
...
import com.fanwe.g419.appview.main.LiveTabDayRankView;
...
import com.fanwe.g419.dialog.LevelUpgradeDialog;
import com.fanwe.g419.event.EIMLoginError;
import com.fanwe.g419.event.EImOnForceOffline;
import com.fanwe.g419.fragment.LiveHomeFragment;
import com.fanwe.g419.fragment.LiveTabMeNewFragment;
...
//        LevelLoginFirstDialog.check(this);
    ...
    private void clickTabLive() {
        getSDFragmentManager().toggle(R.id.fl_container_content, null, LiveHomeFragment.class);
    }

    private void clickTabGame() {
//        getSDFragmentManager().toggle(R.id.fl_container_content, null, BMMessageFragment.class);
//        getSDFragmentManager().toggle(R.id.fl_container_content, null, LiveRechargeDiamondsFragment.class);
        getSDFragmentManager().toggle(R.id.fl_container_content, null, PayBaseFragment.class);
    }
...
//        getSDFragmentManager().toggle(R.id.fl_container_content, null, LiveTabShortVideoFragment.class);
        getSDFragmentManager().toggle(R.id.fl_container_content, null, LiveTabDayRankView.class);
    }
}
