...
public abstract class BMPTDayBaseFragment extends BaseFragment
{
    ...
    {
        return R.layout.bm_frag_popularity_tyrant_day_base;
    }
    @Override
    protected void init()
    {
...
//                .setTextSizeNormal(SDResourcesUtil.getDimensionPixelSize(R.dimen.base_textsize_13)).setTextSizeSelected(SDResourcesUtil.getDimensionPixelSize(R.dimen.base_textsize_13));
        ...
        SDTabUnderline[] items = new SDTabUnderline[]{tab_rank_day, tab_rank_week, tab_rank_month};
